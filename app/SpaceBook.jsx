...
const Spacebook = (props) => {
  ...
  const colors = (props.colors) ? props.colors : ['#150A47', '#600E7A', '#9C0E5F', '#C91A25', '#F2671F', '#979F52', '#594A28']
  ...
  descendingArray.push(content.length)
  while (descendingArray.length < content.length) {
